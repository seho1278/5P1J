...
class CustomUserCreationForm(UserCreationForm):
    ...
    TAG_DICT = {
        '컨셉 & 아이디어' : ['무슨 생각인지 알 수 없는' ,'해석이 새로운', '누구나 이해할 수 있는', '개성있는', '유쾌함을 잃지 않는', '상상력이 무한한'],
        '작품성' : ['러블리한', '영양가 없는', '모던한', '취향을 저격하는', '옛날 감성인', 'B급감성인', '친구들끼리 보는', '애인이랑 보는', '완성도가 높은', '언제 봐도 좋은', '내 눈을 의심하는', '전혀 유쾌하지 않은'],
        '캐릭터' : ['캐릭터가 사랑스러운', '개 잘생긴', '개 예쁜', '띨띨한', '끼부리는', '쥐어박고 싶은', '호구인', '개새끼인', '암걸리는', '천재인', '동물이 주인공인' ],
        '감상평' : ['읭스러운', '감탄사를 연발하는',  '보는 내내 설레는', '웃음이 떠나지 않는', '깜놀하는', '거부감 드는', '경악하는', '추억을 자극하는', '박장대소 하는',  '리뷰를 찾아보는',  '엄청난 충격을 받는',  '지루 할 수 있는'],
        '감독 & 연출' : ['거장의 작품인', '구닥다리인', '레트로한', '특유의 매력이 있는', '기술적인 성취를 보인', '장인정신인', '거침없는', '미친 연출력인', '감독에게 찬사를 보내는', '감독에게 찬사를 보내는', '연출이 과감한'],
        '스토리 & 구성' : ['인생이 담겨있는', '내용 별거 없는', '두서없는', '급발진하는', '막장 드라마인', '완급 조절에 실패한', '내용이 뻔한', '결말이 뻔히 보이는', '내용이 알찬', '속도감 있는', '권선징악인', '반전의 묘미가 있는', '꼬이고 꼬인', '전개가 깔끔한'],
        '편집 & 각본' : ['의식의 흐름', '유행어를 낳은', '가벼운 농담을 던지는', '클리셰를 깨는', '말장난을 하는', '빌드업한', '문학적인'],
        '시각 & 음향' : ['구경하는 재미가 있는', '블링블링한', '색감이 다채로운', '특유의 색감이 있는', '화려한', '영상미가 세련된', '마법 같은', '음악이 조화를 이루는', '한 폭의 그림 같은', '비주얼 쇼크인'],
        '클라이맥스 & 결말' : ['클라이맥스', '마무리가 훈훈한', '극적인 피날레','예상치 못한 결말', '마무리가 훈훈한', '주인공이 행복해지는', '열린 결말인', '결말이 마음에 드는','황급한']
...
#     ]
    ...
    TAG_CHOICES = [
        ...
        ('상영시간이 긴', '상영시간이 긴'),  ('난해한', '난해한'), ('지루한', '지루한'), ('무슨 소리인지 모르겠는', '무슨 소리인지 모르겠는'), ('시대착오적인', '시대착오적인'), ('결말이 부실한', '결말이 부실한'),
    ]
...
class CustomUserChangeForm(UserChangeForm):
    ...
    class Meta(UserChangeForm.Meta):
        model = get_user_model()
        fields = ('first_name', 'birthday', 'email', 'image', 'tags',)
